  ...
  return (
    ...
    >
      ...
      {chatMode === "dev" && messages.length === 0 && (
        <View style={{ backgroundColor: "#0d1117", borderBottomWidth: 1, borderBottomColor: "#21262d", paddingHorizontal: 12, paddingVertical: 8, flexDirection: "row", alignItems: "center", gap: 8 }}>
          <Feather name="zap" size={12} color="#00d4aa" />
          <Text style={{ color: "#8b949e", fontSize: 11, flex: 1, lineHeight: 16 }}>
            <Text style={{ color: "#e6edf3", fontWeight: "700" }}>IA com acesso total:</Text>
            {" "}pesquisa internet, cria e edita arquivos, conecta ao banco de dados. Diga <Text style={{ color: "#00d4aa" }}>"pesquise …"</Text> para buscar na web.
          </Text>
        </View>
      )}
